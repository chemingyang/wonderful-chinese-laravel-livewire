<section>
    <div class="flex justify-between align-items-center gap-3">
        ...
        <div class="flex pb-2">
            ...
            <button onclick="{{ route('lessonmodules.create') }}" class="text-indigo-500 hover:text-indigo-700 font-medium">
                <span class="inline-flex mr-1">    
    ...
    <div class="relative overflow-x-auto">
        <table class="w-full text-sm text-left :text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @if (empty($selected_lesson) || $lessonmodule->lesson_id === intval($selected_lesson))
                    <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        ...
                        <td class="px-5 py-2">
                            {{ $lessons[$lessonmodule->lesson_id] }}
                        </td>
                        <td class="px-5 py-2">
                            {{ $lessonmodule->question }}
                        </td>
                        <td class="px-5 py-2">
                            {{ !empty($lessonmodule->character_id) ? $characters[intval($lessonmodule->character_id)] : '' }}
                        </td>
                        <td class="px-5 py-2">
